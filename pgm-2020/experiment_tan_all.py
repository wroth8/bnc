...
def main():
    ...
    # This rather strange implementation for rng_seeds is to get the same random bnc parameters as in experiment014A
    rng_seeds = np.concatenate([rng_seeds, rng.randint(1, 1e9, size=(n_jobs - 1000,))])
    ...
    random_param_idx = params[1]
    learning_rate_start = params[2]
