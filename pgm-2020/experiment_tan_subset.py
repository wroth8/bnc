...
def main():
    ...
    gridvals_random_augmenting_features = list(range(5))
    gridvals_max_augmenting_features = [3, 6, 9]
    ...
    # Features that we allow for possible TAN connections. We do not allow all possible connections due to efficiency reasons.
    ...
    max_augmenting_features = params[2]
    random_param_idx = params[3]
    ...
    for feature_idx in range(n_features[dataset]):
        if feature_idx + 1 <= max_augmenting_features:
            ...
            randperm = random_augmenting_feature_permutations[random_augmenting_features_idx][feature_idx, :feature_idx]
            augmenting_features_onehot[feature_idx, randperm[:max_augmenting_features-1]] = 1
    ...
    print('random_augmenting_features_idx: {} - possible augmenting features:'.format(random_augmenting_features_idx))
    for feature_idx in range(n_features[dataset]):
